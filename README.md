...
*Note: Related codes for data cleaning is shown in XXX file in the XXX folder of this project.*
...
*Note: Related codes for visualization can be found in the `visual` file in the "Data" folder of this project.*
...
Overall, the test MSE generated by different models fluctuate between 9 and 12. Given that the loan rate (our dependent variable) is provided in percentage scale (e.g. `15` in the data represents a loan rate of 15%) ranging from 6.03 to 26.06 with a mean of 13.83, the test MSE generated by our models is reasonable but not ideal. 
There are a series of potential reasons why the test MSE is high in general:
